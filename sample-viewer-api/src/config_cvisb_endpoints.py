...
CVISB_ENDPOINTS = {
    "sample": {
        ...
        "public_fields": ['samplingDate.lte', 'visitCode', 'samplingDate.gt', 'sampleType', 'dateModified', 'patientID', 'protocolURL', 'AVLinactivated', 'samplingDate.lt', 'derivedIndex', 'species', 'freezingBuffer', 'sampleGroup', 'protocolVersion', 'samplingDate.gte', 'dilutionFactor'],
    ...
    "datacatalog": {
        ...
        "public_fields": ['releaseNotes.version', 'temporalCoverage.gt', 'releaseNotes.overview', 'releaseVersion', 'funding.funder.parentOrganization', 'description', 'dateModified', 'publisher.alternateName', 'spatialCoverage.identifier', 'publisher.logo', 'funding.funder.name', 'spatialCoverage.name', 'dataset', 'releaseNotes.description.endpoint', 'funding.funder.contactPoint.url', 'funding.funder.address.addressCountry.alternateName', 'publisher.address.addressCountry.alternateName', 'funding.funder.address.postalCode', 'releaseNotes.description.description', 'spatialCoverage.url', 'publisher.address.addressCountry.url', 'temporalCoverage.lte', 'publisher.contactPoint.url', 'publisher.address.addressLocality', 'funding.funder.email', 'funding.funder.address.streetAddress', 'publisher.description', 'publisher.contactPoint.email', 'funding.funder.address.addressRegion', 'funding.funder.address.addressLocality', '@id', 'publisher.address.addressCountry.identifier', 'publisher.contactPoint.contactType', 'publisher.address.streetAddress', 'publisher.url', 'funding.funder.description', 'url', 'releaseNotes.datePublished', 'temporalCoverage.gte', 'sameAs', 'publisher.email', 'funding.funder.contactPoint.email', 'funding.funder.address.addressCountry.identifier', 'datePublished', 'funding.funder.url', 'alternateName', 'funding.identifier', 'publisher.address.addressRegion', 'funding.funder.address.addressCountry.url', 'funding.funder.address.addressCountry.name', 'publisher.name', 'funding.funder.alternateName', 'name', 'temporalCoverage.lt', 'publisher.address.postalCode', 'publisher.address.addressCountry.name', 'identifier', 'keywords', 'funding.funder.logo', 'publisher.parentOrganization', 'spatialCoverage.alternateName', 'schemaVersion', 'funding.funder.contactPoint.contactType'],
        "elasticsearch_private_index_body": {
            "settings": CVISB_DEFAULT_SETTINGS,
            "mappings": {
                'datacatalog': {
