...
CVISB_ENDPOINTS = {
    ...
    "datadownload": {
        ...
        "public_fields": ['citation.journalName', 'sourceCode.identifier', 'citation.name', 'sourceCode.author.givenName', 'citation.journalNameAbbrev', 'sourceCode.@id', 'publisher.url', 'sourceCode.author.familyName', 'publisher.email', 'experimentIDs', 'citation.author.name', 'sourceCode.author.address.addressCountry.identifier', 'author.email', 'sourceCode.version', 'author.address.streetAddress', 'sourceCode.author.email', 'sourceCode.citation.author.familyName', 'sourceCode.author.parentOrganization', 'publisher.address.addressCountry.url', 'sourceCode.author.additionalName', 'sameAs', 'publisher.address.postalCode', 'sourceCode.author.url', 'sourceCode.citation.journalNameAbbrev', 'sourceCode.license', 'measurementTechnique', 'citation.issn', 'author.address.addressCountry.url', 'sourceCode.citation.journalName', 'sourceCode.citation.PMID', '@id', 'publisher.alternateName', 'datePublished', 'sourceCode.author.address.addressRegion', 'publisher.address.addressLocality', 'contentUrlIdentifier', 'sourceCode.author.address.addressLocality', 'sourceCode.citation.datePublished', 'sourceCode.programmingLanguage', 'sourceCode.citation.author.givenName', 'publisher.contactPoint.url', 'sourceCode.citation.name', 'name', 'sourceCode.author.description', 'citation.url', 'sourceCode.citation.author.additionalName', 'author.address.postalCode', 'author.address.addressCountry.alternateName', 'sourceCode.citation.identifier', 'author.address.addressCountry.name', 'sourceCode.citation.issueNumber', 'publisher.address.addressCountry.name', 'sourceCode.author.contactPoint.email', 'keywords', 'sourceCode.author.address.streetAddress', 'description', 'author.contactPoint.contactType', 'encodingFormat', 'contentUrlRepository', 'citation.pageStart', 'citation.PMID', 'sourceCode.citation.volumeNumber', 'sourceCode.citation.issn', 'citation.identifier', 'author.address.addressRegion', 'includedInDataset', 'sourceCode.citation.pageEnd', 'author.parentOrganization', 'author.url', 'sourceCode.citation.DOI', 'dateCreated', 'author.address.addressCountry.identifier', 'publisher.contactPoint.contactType', 'citation.volumeNumber', 'publisher.parentOrganization', 'sourceCode.datePublished', 'publisher.contactPoint.email', 'publisher.name', 'sourceCode.author.logo', 'publisher.address.addressCountry.identifier', 'citation.pageEnd', 'contentUrl', 'publisher.address.addressRegion', 'citation.author.familyName', 'citation.author.additionalName', 'citation.issueNumber', 'author.name', 'publisher.logo', 'publisher.address.addressCountry.alternateName', 'sourceCode.citation.url', 'author.alternateName', 'sourceCode.citation.author.name', 'sourceCode.author.address.postalCode', 'author.address.addressLocality', 'sourceCode.codeRepository', 'sourceCode.dateModified', 'sourceCode.author.alternateName', 'sourceCode.author.address.addressCountry.url', 'sourceCode.citation.pageStart', 'additionalType', 'publisher.description', 'author.contactPoint.url', 'publisher.address.streetAddress', 'citation.DOI', 'citation.author.givenName', 'sourceCode.author.address.addressCountry.name', 'sourceCode.author.name', 'author.description', 'author.logo', 'citation.datePublished', 'sourceCode.author.contactPoint.url', 'sourceCode.author.contactPoint.contactType', 'sourceCode.author.address.addressCountry.alternateName', 'isBasedOn', 'sourceCode.name', 'dateModified', 'sourceCode.description', 'author.contactPoint.email', 'identifier'],
        "elasticsearch_public_index_body": {
            "settings": CVISB_DEFAULT_SETTINGS,
            "mappings": {
                "datadownload": {
