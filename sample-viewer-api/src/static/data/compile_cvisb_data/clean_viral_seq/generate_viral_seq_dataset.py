...
def get_viralseq_dataset(dateModified, downloads, metadata, version, datasetVirus):
    ...
    if(datasetVirus == "Ebola"):
        ...
        ds["description"] = "Virus sequencing of acute Ebola patients from Sierra Leone, Liberia, Guinea, and other countries. Virus sequence data will be used to determine potential correlations between the infecting virus genome and patient survival, disease severity and development of sequelae. When multiple sequences are available for one patient, the virus has been sequenced from that patient at several points in time."
