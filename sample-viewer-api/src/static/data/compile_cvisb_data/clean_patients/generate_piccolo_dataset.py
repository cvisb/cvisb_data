...
def get_piccolo_dataset(dateModified, downloadIDs, experiments, countries, version, dataset_id):
    ds = {}
    ...
    ds["name"] = "Piccolo Blood Chemistry of Ebola/Lassa Patients"

    ds["includedInDataCatalog"] = ["https://data.cvisb.org/"]
    ds["url"] = f"https://data.cvisb.org/dataset/{dataset_id}"

    # descriptions
    ds["description"] = "Blood chemistry data of suspected or confirmed Ebola or Lassa Fever patients in the acute phase of infection, collected with a Piccolo Xpress Chemistry Analyzer."
    ds["keywords"] = ["Piccolo",
                      "blood chemsitry",
                      "Ebola",
                      "Ebola virus",
