...
def get_rtpcr_dataset(dateModified, downloadIDs, experiments, countries, version, dataset_id):
    ds = {}
    ...
    # descriptions
    ds["description"] = "RT-PCR measurements of suspected or confirmed Ebola or Lassa Fever patients in the acute phase of infection."
    ds["keywords"] = ["RT-PCR", "Reverse Transcriptase-Polymerase Chain Reaction", "PCR",
                      "Ebola",
                      "Ebola virus",
                      "EBOV",
                      "Lassa",
