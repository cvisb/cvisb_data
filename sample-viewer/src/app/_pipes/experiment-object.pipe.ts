...
export class ExperimentObjectPipe implements PipeTransform {
  exptDict: ExperimentObject[] = [
    ...
    { "dataset_id": "rtpcr-32783920", "icon_id": "RT-PCR", "datasetName": "RT-PCR", "anchor_link": "RT-PCR", "variableMeasured": ["virus level"], "measurementTechnique": ["Reverse Transcriptase-Polymerase Chain Reaction"], "measurementCategory": "clinical measurements" },
    { "dataset_id": "rtpcr-vhf", "icon_id": "RT-PCR", "datasetName": "RT-PCR", "anchor_link": "RT-PCR", "variableMeasured": ["virus level"], "measurementTechnique": ["Reverse Transcriptase-Polymerase Chain Reaction"], "measurementCategory": "clinical measurements" },
